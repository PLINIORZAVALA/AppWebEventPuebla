...
// Check if the user is logged in (based on your session code)
$is_logged_in = isset($_SESSION['id_usuario']); // Assuming 'id_usuario' is set when the user logs in
?>
  ...
  <div id="container">
    <div id="content">
      ...
      <?php
        ...
        $resultado = mysqli_query($link, "SELECT * FROM eventos WHERE tipo_event = 'deportes' AND estado = 'aprobado'");
        if (!$resultado) {
