  ...
  <div id="container">
    <div id="content">
      ...
      <?php
        ...
        // Consultar eventos de tipo especiales
        $resultado = mysqli_query($link, "SELECT * FROM eventos WHERE tipo_event = 'especiales' AND estado = 'aprobado'");
        if (!$resultado) {
        ...
        while ($ren = mysqli_fetch_array($resultado)) {
          ...
          echo "</div>"; // Cerrar div .social-share

          echo "</div>"; // Cerrar div .event-card
          echo "</a>"; // Cerrar enlace al detalle del evento
        }
