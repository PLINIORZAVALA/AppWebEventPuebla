        ...
        <div id="content">
            ...
            <?php
                ...
                if ($ren = mysqli_fetch_assoc($result)) {
                    echo '<form method="POST" action="actuEventoOrg2.php">';
                    echo "<label for='titulo'>Título:</label><input type='text' name='titulo' value='" . htmlspecialchars($ren['titulo']) . "' required>";
                    echo "<label for='descripcion'>Descripción:</label><input type='text' name='descripcion' value='" . htmlspecialchars($ren['descripcion']) . "' required>";
                    echo "<label for='fecha_evento'>Fecha del evento:</label><input type='date' name='fecha_evento' value='" . htmlspecialchars($ren['fecha_evento']) . "' required>";
