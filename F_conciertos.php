...
// Iniciar sesión
session_start();
$is_logged_in = isset($_SESSION['id_usuario']); // Verificar si el usuario ha iniciado sesión
?>
...
<head>
    ...
    <title>Conciertos - Eventos Puebla</title>
...
<div id="wrap">
    ...
    <div id="container">
        <div id="content">
            ...
            // Consultar eventos de tipo conciertos
            $resultado = mysqli_query($link, "SELECT * FROM eventos WHERE tipo_event = 'concierto' AND estado = 'aprobado'");
            if (!$resultado) {
